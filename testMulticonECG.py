...
def publicar_ecg():
    ...
    while True:
        try:
            # Verificar configuraciÃ³n cada 2 segundos para no ralentizar ECG
            ahora = time.time()
            ...
            if not monitoring_active or current_patient_id is None:
                ...
                publicar_status("Esperando activaciÃ³n de monitoreo y ID paciente para ECG...")
                time.sleep(1)
                continue
            
            # Leer datos ECG rÃ¡pidamente
            if ser is not None and ser.in_waiting > 0:
                try:
                    ...
                    # Ignorar errores de codificaciÃ³n
                    pass
                except Exception as e:
        ...
        # Lectura muy rÃ¡pida para capturar todos los datos
        time.sleep(0.001)
